# Usage:  python testSim.py <graphName> <seeds1> <seeds2> ...
# Example: python testSim.py 2.10.020 HighestDegree LocalClustering

import sim
import sys
import json

def loadSeeds(seedsName, graphName):
    # Convert file containing seed nodes to dictionary format for simulation
    numSeeds = int(graphName.split('.')[1])
    seedPath = 'seeds/' + graphName +  '.' + seedsName
