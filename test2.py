...
def transform(filename, numSeeds):
...
nodes[strategy] = transform("Results/" + strategy, 10)
...
results = sim.run(graph, nodes, games)
shaved_results = [i[0] for i in results]
pprint.pprint(shaved_results, width=1)